const form = document.getElementsByClassName("task")[0];
const taskInput = document.querySelector(".task-input");
const collection = document.querySelector('.task-collection');
const clearTasks = document.getElementById("clearBtn");
const filterInput = document.querySelector('.enter-filter');
